package com.inovel.setting.view.borderview;
...
public class BorderEffect implements BorderView.Effect {
    ...
    public FocusListener absListViewFocusListener = new FocusListener() {
        ...
        public void onFocusChanged(View oldFocus, View newFocus) {
            ...
            try {
                LogUtil.d(TAG, "onFocusChanged==>" + oldFocus + " " + newFocus);
                if (oldFocus == null) {
        ...
        try {
            ...
            scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public synchronized void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    //LogUtil.d(TAG,"width:"+width+" height:"+height+" translationX:"+translationX+" translationY:"+translationY);
        ...
        try {
            ...
            if (oldFocus != null && newFocus != null) {
                if (oldFocus.getParent() != newFocus.getParent()) {
                    LogUtil.d(TAG, "=====>" + attacheViews.indexOf(newFocus.getParent()) + "=" + attacheViews.indexOf(oldFocus.getParent()));
    ...
    public void onFocusChanged(View target, View oldFocus, View newFocus) {
        try {
            ...
            mTarget = target;
            LogUtil.d(TAG, "onFocusChanged:111111111" + oldFocus + "=" + newFocus);
            ...
            if (isScrolling || newFocus == null || newFocus.getWidth() <= 0 || newFocus.getHeight() <= 0)
                return;
            LogUtil.d(TAG, "onFocusChanged:2222222222" + oldFocus + "=" + newFocus);
...
//            LogUtil.d(TAG, "onLayout");
    ...
    public void onTouchModeChanged(View target, View attachView, boolean isInTouchMode) {
        try {
            //LogUtil.d(TAG, "onTouchModeChanged:"+isInTouchMode);
...
//                            list.addAll(getScaleAnimator(oldLastFocus, false));
                                ...
                                //LogUtil.d(TAG, "========>SCROLL_STATE_SETTLING=" + mAnimatorSet.isRunning());
                                isScrolling = true;
                                if (lastFocus != null) {
...
//                        LogUtil.d(TAG, "onItemSelected:" + vg.getWidth() + " " + newFocus.getMeasuredWidth() + " w=" + (rect.left - rect.right));
